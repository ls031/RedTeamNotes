...
可以使用命令查看当前终端信息
按下CTRL+Z后显示
![终端美化](KALI2025.4训练版-2026-04-09-20-32-14.png)
在终端中输入，如图所示，别忘了输入reset
![终端美化2](KALI2025.4训练版-2026-04-09-20-32-37.png)

通过查看当前终端参数进行shell的调整

![终端美化3](KALI2025.4训练版-2026-04-09-20-33-56.png)
...
![演示](KALI2025.4训练版-2026-04-09-20-47-55.png)
